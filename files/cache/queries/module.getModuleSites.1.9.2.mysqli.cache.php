...
${'module_srls12_argument'}->checkNotNull();
...
if(${'module_srls12_argument'} !== null) ${'module_srls12_argument'}->setColumnType('number');
...
new ConditionWithArgument('`modules`.`module_srl`',$module_srls12_argument,"in")

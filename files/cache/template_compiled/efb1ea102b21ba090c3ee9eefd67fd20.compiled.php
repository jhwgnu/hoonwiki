...
<section class="section">
	...
	<tr>
		...
		<td>
			...
			<?php echo $__Context->author->name ?> <?php if($__Context->author->homepage || $__Context->author->email_address){ ?>(<?php if($__Context->author->homepage){ ?><a href="<?php echo $__Context->author->homepage ?>" target="_blank" rel="noopener"><?php echo $__Context->author->homepage ?></a><?php };
...
if($__Context->author->email_address){ ?><a href="mailto:<?php echo $__Context->author->email_address ?>"><?php echo $__Context->author->email_address ?></a><?php } ?>)<?php } ?><br />
	...
	<tr>
		...
		<td class="blue"><a href="<?php echo $__Context->component->homepage ?>" target="_blank" rel="noopener"><?php echo $__Context->component->homepage ?></a></td>
	</tr><?php } ?>
	<tr>
